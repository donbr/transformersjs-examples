...
export default function App() {
  ...
  return (
    <div className="demo-container bg-gradient-to-br from-gray-900 to-gray-700 overflow-hidden relative">
      <motion.div
        initial={{ opacity: 1 }}
        animate={{ opacity: status === null ? 1 : 0 }}
        transition={{ duration: 0.5 }}
        className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-gray-800/95 backdrop-blur-md"
      ...
      <div className="demo-scroll-area flex justify-center p-4">
        <div className="max-w-3xl w-full space-y-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-100 mb-2 drop-shadow-lg font-heading">
              WebGPU Text-to-Speech
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 font-semibold font-subheading">
              Powered by&nbsp;
              <a
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-col md:flex-row items-center gap-4">
                <select
                  ...
                  className="w-full md:w-1/2 bg-gray-700/50 backdrop-blur-sm border-2 border-gray-600 rounded-xl text-gray-100 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
                ...
                <button
                  type="submit"
                  className="w-full md:w-1/2 inline-flex justify-center items-center px-6 py-2 text-lg font-semibold bg-gradient-to-t from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 transition-colors duration-300 rounded-xl text-white disabled:opacity-50"
          ...
          {results.length > 0 && (
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              className="max-h-[400px] overflow-y-auto px-2 space-y-6"
            >
              {results.map((result, i) => (
                <div key={i}>
                  <div className="text-white bg-gray-800/70 backdrop-blur-sm border border-gray-700 rounded-lg p-4 relative">
                    <span className="absolute right-5 top-4 font-bold text-gray-400">
                      #{results.length - i}
                    </span>
                    <p className="mb-3 max-w-[95%] break-words">{result.text}</p>
